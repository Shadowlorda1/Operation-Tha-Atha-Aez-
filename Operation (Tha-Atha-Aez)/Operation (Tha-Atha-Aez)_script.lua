...
function OnPopulate() 
    ...
    local colors = {
        ['SeraphimAlly'] = {255, 200, 0}, 
        ['SeraphimAlly2'] = {189, 116, 16}, 
       }
...
function ACU1()
     ...
     units = ScenarioUtils.CreateArmyGroupAsPlatoon('Aeon', 'Comintercept4', 'GrowthFormation')
    for _, v in units:GetPlatoonUnits() do
        ScenarioFramework.GroupPatrolChain({v}, 'Aintercept3')
    end
...
function ACU3() 
	...
	WaitSeconds(10)
	units = ScenarioUtils.CreateArmyGroupAsPlatoon('UEF', 'UEFComintercept2', 'GrowthFormation')
    for _, v in units:GetPlatoonUnits() do
        ScenarioFramework.GroupPatrolChain({v}, 'UEFintercept1')
    end
	
	WaitSeconds(10)
	local units = ScenarioUtils.CreateArmyGroupAsPlatoon('Aeon', 'Comintercept1', 'GrowthFormation')
    for _, v in units:GetPlatoonUnits() do
        ScenarioFramework.GroupPatrolChain({v}, 'Aintercept1')
    end
...
function ACU4()
    ...
    for _, v in units:GetPlatoonUnits() do
        ScenarioFramework.GroupPatrolChain({v}, 'UEFintercept2')
    end
...
function ACU9()
	...
	local units = ScenarioUtils.CreateArmyGroupAsPlatoon('Aeon', 'Comintercept5', 'GrowthFormation')
	 for _, v in units:GetPlatoonUnits() do
       ScenarioFramework.GroupPatrolChain({v}, 'P4Aeonattack1')
	   end
	   units = ScenarioUtils.CreateArmyGroupAsPlatoon('UEF', 'P4UEFattack1', 'GrowthFormation')
	    for _, v in units:GetPlatoonUnits() do
       ScenarioFramework.GroupPatrolChain({v}, 'P4UEFattack1')
	 end
    WaitSeconds(5)
